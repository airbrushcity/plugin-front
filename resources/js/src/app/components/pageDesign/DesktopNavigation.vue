<template>
    <div class="mobile-navigation">
        <div v-show="isNavigationInitialized">
            <ul v-menu id="desk-menu-1" class="mainmenu w-100 p-0 m-0 menu-active">
            ...
            <ul v-menu id="desk-menu-2" class="mainmenu w-100 p-0 m-0">
    ...
    methods:
    {
        ...
        slideTo(category, back)
        {
            ...
            if (this.useFirstContainer)
            {
                ...
                $("#desk-menu-2").trigger("menu-deactivated", { back: !!back });
                $("#desk-menu-1").trigger("menu-activated", { back: !!back });
            }
            else
            {
                ...
                $("#desk-menu-1").trigger("menu-deactivated", { back: !!back });
                $("#desk-menu-2").trigger("menu-activated", { back: !!back });
            }
