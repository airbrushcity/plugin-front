<template>
    <div class="mobile-navigation" :class="{ 'open': isDesktopNavigationOpen }">
        <div v-show="isNavigationInitialized">
            <ul v-menu id="dmenu-1" class="mainmenu w-100 p-0 m-0 menu-active">
            ...
            <ul v-menu id="dmenu-2" class="mainmenu w-100 p-0 m-0">
...
export default {
    ...
    computed:
    {
        ...
        ...mapState({
            ...
            isDesktopNavigationOpen: state => state.navigation.isDesktopNavigationOpen
        })
    },
    ...
    methods:
    {
        ...
        slideTo(category, back)
        {
            ...
            if (this.useFirstContainer)
            {
                ...
                $("#dmenu-2").trigger("menu-deactivated", { back: !!back });
                $("#dmenu-1").trigger("menu-activated", { back: !!back });
            }
            else
            {
                ...
                $("#dmenu-1").trigger("menu-deactivated", { back: !!back });
                $("#dmenu-2").trigger("menu-activated", { back: !!back });
            }
        ...
        closeNavigation()
        {
            this.$store.commit("setIsDesktopNavigationOpen", false);
        },
